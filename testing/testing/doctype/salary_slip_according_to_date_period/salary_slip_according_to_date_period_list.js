				...
				primary_action(data) {
					if (cur_dialog.no_unmarked_days_left) {
						...
						frappe.confirm(
							...
							() => {
								frappe.call({
                                    method: "testing.testing.doctype.salary_slip_according_to_date_period.salary_slip_according_to_date_period.mark_bulk_attendance",
									args: {
										data: data,
									},
									callback: function (r) {
                                        ...
                                        frappe.set_route(`/salary-slip-according-to-date-period/${data.employee}`);
									},
								});
							}
						);
